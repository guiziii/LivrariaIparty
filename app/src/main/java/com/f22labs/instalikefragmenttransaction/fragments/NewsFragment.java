...
public class NewsFragment extends SupportMapFragment implements OnMapReadyCallback, GoogleMap.OnMapClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getMapAsync(this);
        ( (MainActivity)getActivity()).updateToolbarTitle("Mapa de Eventos");
        ( (MainActivity)getActivity()).updateToolbarSubTitle("Eventos de acordo com sua posição");
